...
---
## Code Workbook on Posit Cloud:
https://posit.cloud/content/10206448

## Code Workbook on Github:
https://github.com/SyedHassan20/causal-inference/blob/main/Assignment_3.Rmd

```{r}
#installing packages
#UNCOMMENT THIS TO INSTALL PACKAGES
install.packages(c("readr", "dplyr", "ggplot2", "caret", "Matching", "sensemakr", "rio", "Synth","curl", "googledrive", "lubridate"))
```
